                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control mb-3"
                                                   ...
                                                   id="fact" name="fact"
                                                   value="<?php echo e($program['fact']); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="plan">Плановое значение</label>
                                            <input type="number" class="form-control mb-3"
                                                   placeholder="Плановое значение"
                                                   id="plan" name="plan" value="<?php echo e($program['plan']); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="university">Название университета</label>
                                            <input type="text" class="form-control mb-3"
                                                   placeholder="Название университета"
                                                   id="university" name="university" value="<?php echo e($program['university']); ?>">
                                        </div>
                                    </div>
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    ...
                                                    <div class="widget-content widget-content-area">
                                                        <div id="editor-container">
                                                            <label for="hiddenArea"><?php echo $program['name']; ?></label>
